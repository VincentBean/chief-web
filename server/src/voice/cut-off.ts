/** How much of an interrupted reply the cut-off note quotes back (docs/voice-plan.md §5). */
export const CUT_OFF_QUOTE_CHARS = 200;

/**
 * The note that opens the next message to an agent the operator talked over
 * (voice US-020; docs/voice-plan.md §5): `[You were interrupted after saying: "<tail>"]`,
